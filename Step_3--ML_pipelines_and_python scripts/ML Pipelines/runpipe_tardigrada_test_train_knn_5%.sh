...
python3 ${SCRIPTDIR}/create_test_train_split.py \
        --tag "tardigrada-5%-knn" -l "Label" \
        tardigrada_data/Tardigrada_2MajOrder_oh_5per.csv

# calculate the projection for this split
python3 ${SCRIPTDIR}/calculate_data_projection_knn.py \
                "tardigrada-5%-knn-train-vs-test"

# run SVN on the datea
python3 ${SCRIPTDIR}/evaluate_knn.py --fig "tardigrada-5%-knn-train-vs-test"
