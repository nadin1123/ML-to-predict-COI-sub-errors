...
output=annelida-5%-rf-2ds-train-vs-test/output.txt
...
python3 ${SCRIPTDIR}/calculate_data_projection_rf.py \
                "annelida-5%-rf-2ds-train-vs-test"

# run LR on the data
python3 ${SCRIPTDIR}/evaluate_rf.py --fig "annelida-5%-rf-2ds-train-vs-test" | tee $output
