...
##
## Use "grid search" to find good values for our NB for this
## training set.
##
...
outcome.to_csv('%s/nb_outcome.csv' % DATA_DIRNAME, index=False)
...
confusion.print_confusion_matrix(cm, CLASS_NAMES, y_training,
		filename="%s/nb_confusion.txt" % DATA_DIRNAME)

if MAKE_FIG:
	confusion.confusion_matrix_heatmap(
            '%s/nb_confusion_heatmap.pdf' % DATA_DIRNAME,
